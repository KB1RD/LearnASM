...
<center class="no-text-select"><svg xmlns="http://www.w3.org/2000/svg" width="448" height="1664" viewBox="0 0 448 768.00001">
  ...
  <g transform="translate(0 -736)">
    <path d="M148.5 795.91316v-80l96-48-96-48v-80l192 96v64z" fill="none" stroke="#000"/>
    ...
    <path fill="none" stroke="#000" stroke-width="1.00878429" stroke-linecap="round" stroke-dashoffset="10" d="M148.5043921 828.86659777h190.99123v94.991219h-190.99123z"/>
    <text y="975.69299" x="95.483536" style="line-height:125%" font-weight="400" font-size="5" font-family="sans-serif" letter-spacing="0" word-spacing="0" transform="translate(147.4434638 -127.44346223)">
    ...
    <!-- CONTROL UNIT -->
    <path fill="none" stroke="#000" stroke-width="1.00878429" d="M148.50439 406.866596h190.99123v94.991219H148.50439z"/>
    ...
    <!-- CENTRAL BUS -->
    <path fill="none" stroke="#000" stroke-width=".824256" stroke-linecap="round" stroke-dashoffset="10" d="M16.412134 300.77432h415.17575v47.175743H16.412134z"/>
    ...
    <g v-for="(reg, i) in cpu.registers" v-bind:transform="'translate(0,'+(128*i).toString()+')'">
      ...
      <g transform="translate(144.22906 -478.45512)">
        <path class="vis-path-sm vis-path-arrowend" d="M2.77094 1466.8173h-103" v-bind:disabled="!(cpu.visual_info.src1_reg == i && !cpu.visual_info.immediate)"/><!-- SRC1 OUT -->
        <path class="vis-path-sm vis-path-arrowend" d="M3.1276622 1498.8173H-52.22906" v-bind:disabled="!(cpu.visual_info.src0_reg == i)"/><!-- SRC0 OUT -->
        <path class="vis-path-sm vis-path-arrowend" d="M260.37621 1482.8173h-57.67527" v-bind:disabled="!(cpu.visual_info.dest_reg == i)"/><!-- DEST IN -->
      </g>
    </g>
